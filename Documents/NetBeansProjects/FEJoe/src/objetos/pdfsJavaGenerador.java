...
public class pdfsJavaGenerador {
    ...
    private static final Font chapterFont = FontFactory.getFont(FontFactory.HELVETICA, 26, Font.BOLDITALIC,Color.RED);
...
*/
    ...
    private void imprimirCuerpo() {
        try {
            ...
            PdfPCell columnaHeader;
            //tabla.addCell(columnaHeader);
            for (int column = 0; column < 6; column++) {
                columnaHeader = new PdfPCell(new Phrase("COL " + column));
                columnaHeader.setHorizontalAlignment(Element.ALIGN_CENTER);
                columnaHeader.setBackgroundColor(Color.LIGHT_GRAY);
                tabla.addCell(columnaHeader);
            }
