...
public class ArticulosMod extends javax.swing.JInternalFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (editable.EliminacionDeObjeto(arti)) {
            this.dispose();
        }
    ...
    private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            String dd=this.jTextField1.getText().toUpperCase();
    ...
    private void jTextField10KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField10KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            Double costoo = Numeros.ConvertirStringADouble(this.jTextField4.getText());
            Double porciento = Numeros.ConvertirStringADouble(this.jTextField10.getText());
            if (porciento > 0) {
                porciento=porciento / 100;
                porciento=porciento + 1;
                Double total =Math.round((costoo * porciento) * 100.0) / 100.0;
                this.jTextField5.setText(String.valueOf(total));
                Double mayorista=Numeros.ConvertirStringADouble(this.jTextField6.getText());
                if(mayorista == 0.00)this.jTextField6.setText(String.valueOf(total));
            }
